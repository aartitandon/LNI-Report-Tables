...
unique.aid.device.language.2 <- left_join


table(unique.aid.device.language$device_cat.x, unique.aid.device.language$device_cat.y)
table(unique.aid.device.language$device_cat.y, unique.aid.device.language$device_cat.x)
install.packages("dplyr")
CrossTable(unique.aid.device.language$device_cat.x, unique.aid.device.language$device_cat.y, prop.chisq = FALSE)
